      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md shadow-lg">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4 lg:py-6 flex justify-between items-center">
          ...
          <div className="flex gap-3 lg:gap-6 items-center text-sm lg:text-lg">
            <Link href="/" className="relative text-gray-700 hover:text-gray-900 transition-colors duration-300 hidden sm:block py-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#163159] after:transition-all after:duration-300 hover:after:w-full">{t.nav.home}</Link>
            ...
            <Link href="/services" className="relative text-gray-900 font-semibold py-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#163159] after:transition-all after:duration-300 hover:after:w-full">{t.nav.services}</Link>

          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-2 lg:order-1">
              <div className="relative">
                <div className="w-16 h-16 bg-[#163159] rounded-2xl flex items-center justify-center mb-6">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#163159] flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-20 lg:py-32 px-4 lg:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-[#163159] to-[#0f2340] rounded-3xl opacity-20 blur-2xl"></div>
